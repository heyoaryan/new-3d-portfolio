          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="p-6 rounded-2xl border-[.5px] border-zinc-600 hover:border-zinc-400 transition-all duration-300">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <h3 className="text-xl font-semibold">Green Valley Convent School</h3>
            ...
            <div className="p-6 rounded-2xl border-[.5px] border-zinc-600 hover:border-zinc-400 transition-all duration-300">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <h3 className="text-xl font-semibold">Navadha Fashion Co.</h3>
              ...
              <Link href="https://www.navadhafashion.com" target="_blank"
                ...
                navadhafashion.com <ExternalLink size={14} />
              </Link>
            </div>
          </div>
      ...
      <BlurIn delay={1.3}>
        ...
        >
          ...
          <Link
            ...
            target="_blank"
          >
            <button className="inline-flex items-center gap-2 bg-green-500 text-white px-6 py-3 rounded-xl font-semibold hover:bg-green-400 transition-colors">
