            ...
            <div className="p-5 sm:p-6 rounded-2xl border-[.5px] border-zinc-300 dark:border-zinc-600 hover:border-zinc-400 transition-all duration-300">
              <div className="flex items-start gap-3 mb-3">
                ...
                <div className="min-w-0">
                  <h3 className="text-lg sm:text-xl font-semibold leading-tight">Green Valley Convent School</h3>
              ...
              <Link href="https://www.greenvalleyconventschool.in" target="_blank"
                ...
                greenvalleyconventschool.in <ExternalLink size={13} className="flex-shrink-0" />
              </Link>
            </div>
            <div className="p-5 sm:p-6 rounded-2xl border-[.5px] border-zinc-300 dark:border-zinc-600 hover:border-zinc-400 transition-all duration-300">
              <div className="flex items-start gap-3 mb-3">
                ...
                <div className="min-w-0">
                  <h3 className="text-lg sm:text-xl font-semibold leading-tight">Navadha Fashion Co.</h3>
              ...
              <Link href="https://www.navadhafashion.com" target="_blank"
                ...
                navadhafashion.com <ExternalLink size={13} className="flex-shrink-0" />
              </Link>
            </div>
          </div>
        ...
        {SERVICES.map((service, index) => (
          <BoxReveal key={service.title} delay={0.8 + index * 0.15} width="100%">
            ...
            >
              ...
              <p className="text-base sm:text-lg font-bold mb-3">{service.price}</p>
